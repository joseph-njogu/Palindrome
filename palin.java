...
{ 
	...
	{ 
		System.out.println("Enter a long number of your choice");
		int num[] = {  4, 1, 8}; 
		generateNextPalindrome(num, num.length); 
	} 
} 
//to run this code you need to have installed jdk into your system.
//run it using the command prompt with commands
//javac palin.java
